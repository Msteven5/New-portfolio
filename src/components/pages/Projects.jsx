    ...
    <div>
        ...
        <div className="row p-3 m-1 w-auto" id="project1">
          <div className="p-2 w-auto">
            ...
            <img src="/translate app screenshot.png" id="firstProject"
              className="card-img-top  border border-5 border-warning" alt="A screenshot of a translation app" />
      ...
      <div className="row justify-content-center" id="restOfProjects">
        ...
        <div className="m-4 p-4 w-25">
          <img src="/weather viewing app screenshot.png" height="150px" className="card-img-top" alt="..." />
          <div className="card-body">
        ...
        <div className="m-4 p-4 w-25">
          <img src="/timed coding quiz screenshot.png" height="150px" className="card-img-top" alt="..." />
          <div className="card-body">
            <h5 className="card-title my-2">Card title</h5>
            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's
              content.</p>
        ...
        <div className="m-4 p-4 w-25" id="lastProject">
          <img src="/README Generator Screenshot.png" height="150px" className="card-img-top" alt="..." />
          <div className="card-body">
